...
namespace CafeAPI.DAO
{
    class Connection
    {
        private string strconn = @"data source=.;initial catalog=QuanCafe;user id=sa;password=12345;multipleactiveresultsets=True;";
        ...
        public int Excute_Sql_GetMaxID(string strQuery)
        {
            this.Conn.Open();
            int efftectRecord = 0;
            SqlCommand sqlcmd = new SqlCommand();
